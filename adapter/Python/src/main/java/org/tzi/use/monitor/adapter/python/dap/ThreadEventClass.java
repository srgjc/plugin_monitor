...
public class ThreadEventClass {
    ...
    private ThreadEventEvent event;
     ...
     */
    @JsonProperty("body")
    public ThreadEventBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(ThreadEventBody value) { this.body = value; }

    /**
     * Type of event.
     */
    @JsonProperty("event")
    public ThreadEventEvent getEvent() { return event; }
    @JsonProperty("event")
    public void setEvent(ThreadEventEvent value) { this.event = value; }
}

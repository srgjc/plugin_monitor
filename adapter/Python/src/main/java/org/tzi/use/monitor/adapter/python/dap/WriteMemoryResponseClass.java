 ...
 */
public class WriteMemoryResponseClass {
    private long seq;
    private AttachResponseType type;
    private WriteMemoryResponseBody body;
     ...
     */
    @JsonProperty("body")
    public WriteMemoryResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(WriteMemoryResponseBody value) { this.body = value; }

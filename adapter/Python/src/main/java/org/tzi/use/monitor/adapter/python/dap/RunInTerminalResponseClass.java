 ...
 */
public class RunInTerminalResponseClass {
    private long seq;
    private AttachResponseType type;
    private RunInTerminalResponseBody body;
     ...
     */
    @JsonProperty("body")
    public RunInTerminalResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(RunInTerminalResponseBody value) { this.body = value; }

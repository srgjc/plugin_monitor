...
public class ReverseContinueArguments {
    ...
    @JsonPropertyDescription("Specifies the active thread. If the debug adapter supports single thread execution (see `supportsSingleThreadExecutionRequests`) and the `singleThread` argument is true, only the thread with this ID is resumed.")
    ...
    @JsonPropertyDescription("If this flag is true, backward execution is resumed only for the thread with given `threadId`.")
    ...
    public String toString() {
        ...
        sb.append(ReverseContinueArguments.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("threadId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ReverseContinueArguments) == false) {
            return false;
        }
        ReverseContinueArguments rhs = ((ReverseContinueArguments) other);

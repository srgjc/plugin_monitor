 ...
 * single thread execution (see capability `supportsSingleThreadExecutionRequests`), setting
 * the `singleThread` argument to true resumes only the specified thread. If not all threads
 ...
 * is true.
 */
public class ReverseContinueRequestClass {
    private long seq;
    private AttachRequestType type;
    private ReverseContinueRequestArguments arguments;
    private ReverseContinueRequestCommand command;
    ...
    public ReverseContinueRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(ReverseContinueRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public ReverseContinueRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(ReverseContinueRequestCommand value) { this.command = value; }
}

 ...
 */
public class DisassembleResponseClass {
    private long seq;
    private AttachResponseType type;
    private DisassembleResponseBody body;
     ...
     */
    @JsonProperty("body")
    public DisassembleResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(DisassembleResponseBody value) { this.body = value; }

 ...
 */
public class SetVariableResponseClass {
    private long seq;
     ...
     */
    @JsonProperty("body")
    public SetVariableResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(SetVariableResponseBody value) { this.body = value; }

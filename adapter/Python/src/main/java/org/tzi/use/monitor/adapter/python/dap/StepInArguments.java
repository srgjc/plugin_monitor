...
public class StepInArguments {
    ...
    @JsonPropertyDescription("Specifies the thread for which to resume execution for one step-into (of the given granularity).")
    ...
    @JsonPropertyDescription("Id of the target to step into.")
    ...
    public String toString() {
        ...
        sb.append(StepInArguments.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("threadId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StepInArguments) == false) {
            return false;
        }
        StepInArguments rhs = ((StepInArguments) other);

 ...
 */
public class DataBreakpointInfoRequestClass {
    private long seq;
    private AttachRequestType type;
    private DataBreakpointInfoRequestArguments arguments;
    private DataBreakpointInfoRequestCommand command;
    ...
    public DataBreakpointInfoRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(DataBreakpointInfoRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public DataBreakpointInfoRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(DataBreakpointInfoRequestCommand value) { this.command = value; }
}

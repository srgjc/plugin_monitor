 ...
 */
public class ExceptionInfoResponseClass {
    private long seq;
     ...
     */
    @JsonProperty("body")
    public ExceptionInfoResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(ExceptionInfoResponseBody value) { this.body = value; }

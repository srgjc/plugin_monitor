 ...
 *
 * The `breakpointLocations` request returns all possible locations for source breakpoints
 * in a given range.
 * Clients should only call this request if the corresponding capability
 * `supportsBreakpointLocationsRequest` is true.
 */
public class BreakpointLocationsRequestClass {
    private long seq;
    private AttachRequestType type;
    private BreakpointLocationsRequestArguments arguments;
    private BreakpointLocationsRequestCommand command;
    ...
    public BreakpointLocationsRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(BreakpointLocationsRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public BreakpointLocationsRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(BreakpointLocationsRequestCommand value) { this.command = value; }
}

 ...
 */
public class ReadMemoryResponseClass {
    private long seq;
    private AttachResponseType type;
    private ReadMemoryResponseBody body;
     ...
     */
    @JsonProperty("body")
    public ReadMemoryResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(ReadMemoryResponseBody value) { this.body = value; }

 ...
 *
 * The event signals that the progress reporting needs to be updated with a new message
 * and/or percentage.
 * The client does not have to update the UI immediately, but the clients needs to keep
 * track of the message and/or percentage values.
 * This event should only be sent if the corresponding capability
 * `supportsProgressReporting` is true.
 */
public class ProgressUpdateEventClass {
    private long seq;
    private BreakpointEventType type;
    private ProgressUpdateEventBody body;
    private ProgressUpdateEventEvent event;
     ...
     */
    @JsonProperty("body")
    public ProgressUpdateEventBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(ProgressUpdateEventBody value) { this.body = value; }

    /**
     * Type of event.
     */
    @JsonProperty("event")
    public ProgressUpdateEventEvent getEvent() { return event; }
    @JsonProperty("event")
    public void setEvent(ProgressUpdateEventEvent value) { this.event = value; }
}

 ...
 */
public class SourceResponseClass {
    private long seq;
    private AttachResponseType type;
    private SourceResponseBody body;
     ...
     */
    @JsonProperty("body")
    public SourceResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(SourceResponseBody value) { this.body = value; }

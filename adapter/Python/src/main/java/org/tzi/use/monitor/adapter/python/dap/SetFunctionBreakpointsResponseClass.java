 ...
 */
public class SetFunctionBreakpointsResponseClass {
    private long seq;
    private AttachResponseType type;
    private SetFunctionBreakpointsResponseBody body;
     ...
     */
    @JsonProperty("body")
    public SetFunctionBreakpointsResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(SetFunctionBreakpointsResponseBody value) { this.body = value; }

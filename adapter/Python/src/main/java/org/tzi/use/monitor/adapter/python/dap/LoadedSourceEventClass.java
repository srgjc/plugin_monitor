 ...
 * all loaded sources.
 */
public class LoadedSourceEventClass {
    private long seq;
    private BreakpointEventType type;
    private LoadedSourceEventBody body;
    private LoadedSourceEventEvent event;
     ...
     */
    @JsonProperty("body")
    public LoadedSourceEventBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(LoadedSourceEventBody value) { this.body = value; }

    /**
     * Type of event.
     */
    @JsonProperty("event")
    public LoadedSourceEventEvent getEvent() { return event; }
    @JsonProperty("event")
    public void setEvent(LoadedSourceEventEvent value) { this.event = value; }
}

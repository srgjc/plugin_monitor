...
public class StepBackArguments {
    ...
    @JsonPropertyDescription("Specifies the thread for which to resume execution for one step backwards (of the given granularity).")
    ...
    public String toString() {
        ...
        sb.append(StepBackArguments.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("threadId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StepBackArguments) == false) {
            return false;
        }
        StepBackArguments rhs = ((StepBackArguments) other);

 ...
 */
public class SetDataBreakpointsResponseClass {
    private long seq;
    private AttachResponseType type;
    private SetDataBreakpointsResponseBody body;
     ...
     */
    @JsonProperty("body")
    public SetDataBreakpointsResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(SetDataBreakpointsResponseBody value) { this.body = value; }

 ...
 */
public class TerminateThreadsRequestClass {
    private long seq;
    private AttachRequestType type;
    private TerminateThreadsRequestArguments arguments;
    private TerminateThreadsRequestCommand command;
    ...
    public TerminateThreadsRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(TerminateThreadsRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public TerminateThreadsRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(TerminateThreadsRequestCommand value) { this.command = value; }
}

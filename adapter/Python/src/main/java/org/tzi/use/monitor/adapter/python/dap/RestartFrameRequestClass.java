 ...
 */
public class RestartFrameRequestClass {
    private long seq;
    private AttachRequestType type;
    private RestartFrameRequestArguments arguments;
    private RestartFrameRequestCommand command;
    ...
    public RestartFrameRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(RestartFrameRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public RestartFrameRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(RestartFrameRequestCommand value) { this.command = value; }
}

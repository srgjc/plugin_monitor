...
public class TerminateArguments {
    ...
    @JsonPropertyDescription("A value of true indicates that this `terminate` request is part of a restart sequence.")
    ...
    public String toString() {
        ...
        sb.append(TerminateArguments.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("restart");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TerminateArguments) == false) {
            return false;
        }
        TerminateArguments rhs = ((TerminateArguments) other);

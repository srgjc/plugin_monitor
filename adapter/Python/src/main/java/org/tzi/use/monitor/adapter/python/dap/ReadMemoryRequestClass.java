 ...
 */
public class ReadMemoryRequestClass {
    private long seq;
    private AttachRequestType type;
    private ReadMemoryRequestArguments arguments;
    private ReadMemoryRequestCommand command;
    ...
    public ReadMemoryRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(ReadMemoryRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public ReadMemoryRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(ReadMemoryRequestCommand value) { this.command = value; }
}

 ...
 */
public class SetInstructionBreakpointsResponseClass {
    private long seq;
    private AttachResponseType type;
    private SetInstructionBreakpointsResponseBody body;
     ...
     */
    @JsonProperty("body")
    public SetInstructionBreakpointsResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(SetInstructionBreakpointsResponseBody value) { this.body = value; }

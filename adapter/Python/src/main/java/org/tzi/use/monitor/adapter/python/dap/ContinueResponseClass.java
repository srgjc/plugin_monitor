...
public class ContinueResponseClass implements DAPResponse {
    private long seq;
    private String type;
     ...
     */
    @JsonProperty("body")
    public ContinueResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(ContinueResponseBody value) { this.body = value; }

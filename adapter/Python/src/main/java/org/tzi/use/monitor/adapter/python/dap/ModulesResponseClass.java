 ...
 */
public class ModulesResponseClass {
    private long seq;
    private AttachResponseType type;
    private ModulesResponseBody body;
     ...
     */
    @JsonProperty("body")
    public ModulesResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(ModulesResponseBody value) { this.body = value; }

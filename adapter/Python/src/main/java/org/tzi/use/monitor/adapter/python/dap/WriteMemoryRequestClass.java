 ...
 */
public class WriteMemoryRequestClass {
    private long seq;
    private AttachRequestType type;
    private WriteMemoryRequestArguments arguments;
    private WriteMemoryRequestCommand command;
    ...
    public WriteMemoryRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(WriteMemoryRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public WriteMemoryRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(WriteMemoryRequestCommand value) { this.command = value; }
}

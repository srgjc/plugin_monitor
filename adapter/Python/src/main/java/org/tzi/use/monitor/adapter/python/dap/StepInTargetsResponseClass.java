 ...
 */
public class StepInTargetsResponseClass {
    private long seq;
     ...
     */
    @JsonProperty("body")
    public StepInTargetsResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(StepInTargetsResponseBody value) { this.body = value; }

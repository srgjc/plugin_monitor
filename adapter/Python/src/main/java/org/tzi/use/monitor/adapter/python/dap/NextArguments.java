...
public class NextArguments {
    ...
    @JsonPropertyDescription("Specifies the thread for which to resume execution for one step (of the given granularity).")
    ...
    public String toString() {
        ...
        sb.append(NextArguments.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("threadId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NextArguments) == false) {
            return false;
        }
        NextArguments rhs = ((NextArguments) other);
    ...
    public enum SteppingGranularity {
        ...
        private final static Map<String, SteppingGranularity> CONSTANTS = new HashMap<String, SteppingGranularity>();

        static {
            for (SteppingGranularity c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        SteppingGranularity(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static SteppingGranularity fromValue(String value) {
            SteppingGranularity constant = CONSTANTS.get(value);
            if (constant == null) {

 ...
 */
public class StepInTargetsRequestClass {
    private long seq;
    private AttachRequestType type;
    private StepInTargetsRequestArguments arguments;
    private StepInTargetsRequestCommand command;
    ...
    public StepInTargetsRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(StepInTargetsRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public StepInTargetsRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(StepInTargetsRequestCommand value) { this.command = value; }
}

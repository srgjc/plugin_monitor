 ...
 */
public class CompletionsResponseClass {
    private long seq;
     ...
     */
    @JsonProperty("body")
    public CompletionsResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(CompletionsResponseBody value) { this.body = value; }

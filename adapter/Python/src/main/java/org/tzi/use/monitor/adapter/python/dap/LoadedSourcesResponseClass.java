 ...
 */
public class LoadedSourcesResponseClass {
    private long seq;
    private AttachResponseType type;
    private LoadedSourcesResponseBody body;
     ...
     */
    @JsonProperty("body")
    public LoadedSourcesResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(LoadedSourcesResponseBody value) { this.body = value; }

...
public class EvaluateResponseClass implements DAPResponse {
    private long seq;
    private String type;
     ...
     */
    @JsonProperty("body")
    public EvaluateResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(EvaluateResponseBody value) { this.body = value; }

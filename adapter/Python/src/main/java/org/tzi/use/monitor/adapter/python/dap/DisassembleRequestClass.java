 ...
 */
public class DisassembleRequestClass {
    private long seq;
    private AttachRequestType type;
    private DisassembleRequestArguments arguments;
    private DisassembleRequestCommand command;
    ...
    public DisassembleRequestArguments getArguments() { return arguments; }
    @JsonProperty("arguments")
    public void setArguments(DisassembleRequestArguments value) { this.arguments = value; }

    /**
     * The command to execute.
     */
    @JsonProperty("command")
    public DisassembleRequestCommand getCommand() { return command; }
    @JsonProperty("command")
    public void setCommand(DisassembleRequestCommand value) { this.command = value; }
}

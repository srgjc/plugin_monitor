 ...
 */
public class DataBreakpointInfoResponseClass {
    private long seq;
    private AttachResponseType type;
    private DataBreakpointInfoResponseBody body;
     ...
     */
    @JsonProperty("body")
    public DataBreakpointInfoResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(DataBreakpointInfoResponseBody value) { this.body = value; }

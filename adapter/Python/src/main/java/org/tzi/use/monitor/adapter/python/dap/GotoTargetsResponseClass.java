 ...
 */
public class GotoTargetsResponseClass {
    private long seq;
    private AttachResponseType type;
    private GotoTargetsResponseBody body;
     ...
     */
    @JsonProperty("body")
    public GotoTargetsResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(GotoTargetsResponseBody value) { this.body = value; }

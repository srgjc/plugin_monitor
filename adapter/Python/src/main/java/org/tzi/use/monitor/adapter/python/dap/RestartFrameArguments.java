...
public class RestartFrameArguments {
    ...
    @JsonPropertyDescription("Restart the stack frame identified by `frameId`. The `frameId` must have been obtained in the current suspended state. See 'Lifetime of Object References' in the Overview section for details.")
    ...
    public String toString() {
        ...
        sb.append(RestartFrameArguments.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("frameId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RestartFrameArguments) == false) {
            return false;
        }
        RestartFrameArguments rhs = ((RestartFrameArguments) other);

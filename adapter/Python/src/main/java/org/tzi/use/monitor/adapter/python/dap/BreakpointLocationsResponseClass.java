 ...
 */
public class BreakpointLocationsResponseClass {
    private long seq;
    private AttachResponseType type;
    private BreakpointLocationsResponseBody body;
     ...
     */
    @JsonProperty("body")
    public BreakpointLocationsResponseBody getBody() { return body; }
    @JsonProperty("body")
    public void setBody(BreakpointLocationsResponseBody value) { this.body = value; }
